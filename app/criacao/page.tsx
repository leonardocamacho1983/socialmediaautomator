...
export default async function CreationPage({ searchParams }: PageProps) {
        ...
        <div className="mx-auto flex max-w-7xl flex-col gap-6">
          <section className="rounded-[2rem] border border-white/10 bg-white/[0.06] p-6 shadow-2xl shadow-black/20 backdrop-blur lg:p-8">
            ...
            <h1 className="max-w-3xl text-4xl font-semibold tracking-tight text-white md:text-5xl">
              Drafts e previews editoriais.
            </h1>
            <p className="mt-4 max-w-2xl text-base leading-7 text-zinc-300">
              Aqui entram copy, formato, mídia sugerida e direção visual antes
